...
export function FileUpload({ ...params }) {
    ...
    return (
        <Button variant="contained" component="label" style={style}>
            {params.name}
...
export function DownloadExcel({ ...params }) {
    ...
    return (
        <Button variant="contained" style={params.style} onClick={params.static ? InstallStaticStructure : InstallDynamicStructure} component="label">
            {params.name}
        </Button>
    )
}