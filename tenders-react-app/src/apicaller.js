...
export const AddUser = async (Userdetail) => {
    var responseget = Object()
    const REACT_APP_API_ = process.env.REACT_APP_API_URL;
    const res = await axios.post(REACT_APP_API_ + "adduseradmin", Userdetail).then((response) => {
        responseget = response
    })
    return responseget
}

export const AddClientHistory = async (data) => {
    var responseget = Object()
    const REACT_APP_API_ = process.env.REACT_APP_API_URL;
    const res = await axios.post(REACT_APP_API_ + "addclienthistory", data).then((response) => {
        responseget = response
    })
    return responseget
}
