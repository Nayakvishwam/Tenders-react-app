...
import { ImportuserTypesDetails, rights } from "../ImportVariables";

const SideNavbar = () => {
    let { username,
        typeuser, department } = GetUserDetails()
    ...
    return (
        <nav className="sidebar sidebar-offcanvas" id="sidebar">
            <ul className="nav">
                ...
                {
                    ((rights.user.typeuser?.includes(typeuser)) || (typeuser == "admin")) && (<li className={PathActive("/app/users") ? "nav-item active" : "nav-item"}>
                ...
                <li className={"nav-item"}>
                    ...
                    <Collapse in={OpenChildMenu.activation} className="nav-item">
                        <ul className={"nav flex-column sub-menu"}>
                            ...
                            {
                                ((rights.viewclients[typeuser]?.includes(department)) || (typeuser == "admin"))
                                &&
                                (<li className="nav-item">
                                    <Link className={PathActive("/app/clients") ? "nav-link active" : "nav-link"} to="/app/clients">
                                        Clients
                                    </Link>
                                </li>)
                            }
